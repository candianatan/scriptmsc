...
SCPresq="HR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0FBQUFBRVhRT1N5SXBOMkpaMGVoVVEvQURNLVVMVElNQVRFLU5FVy1GUkVFL21hc3Rlci9yZXF1ZXN0"
SUB_DOM='base64 -d'
...
IP="54.36.136.254" && echo "$IP" > /usr/bin/vendor_code
cd $HOME
msg -ne "Key: "
